...
@interface SubirFotoViewController : UIViewController <UIImagePickerControllerDelegate>
{
    
}

@property (nonatomic, strong) NSMutableArray *arrImagenes;
@property (weak, nonatomic) IBOutlet UIImageView *imgPrevio;
...
@property (weak, nonatomic) IBOutlet UIProgressView *pbEstatusSubida;
